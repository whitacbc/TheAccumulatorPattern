...
def run_test_factorial():
    ...
    #Test 3
    answer_from_oracle = math.factorial(54)
    answer_from_my_code = factorial(54)
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 4
    answer = count_cosines_from(3, 15, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 6
    answer = count_cosines_from(3, 20, 0.45)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 14
    answer = count_cosines_from(3, 70, 0.80)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = 1.7178571  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected =  1.2644063238103487  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(6, 20)
